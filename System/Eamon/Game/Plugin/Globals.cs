...
#pragma warning disable IDE1006 // Naming Styles
	...
	{
		/// <summary>
		/// Gets or sets the Eamon CS game engine which serves as the primary entry point for accessing and managing
		...
		/// <summary>Gets the global Record database.</summary>
		/// <remarks>
		...
		/// <summary>Gets the <see cref="IArtifact">Artifact</see> database.</summary>
		/// <remarks>
		...
		/// <summary>Gets the <see cref="IEffect">Effect</see> database.</summary>
		/// <remarks>
		...
		/// <summary>Gets the <see cref="IMonster">Monster</see> database.</summary>
		/// <remarks>
