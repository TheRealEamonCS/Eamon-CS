...
namespace Eamon.Game.Helpers.Generic
{
	public abstract class Helper<T> : IHelper<T> where T : class, IGameBase
	{
		...
		/// <summary></summary>
		public Type _lastFieldNameListType;

		/// <summary></summary>
		public IList<string> _fieldNameList;
		...
		public virtual T Record
		{
			...
			set
			{
				if (_record != value)
				{
					if (_fieldNameList != null && value != null && (_fieldNameList.Count == 0 || value.GetType() != _lastFieldNameListType))
					{
						...
						{
							_fieldNameList.Add(propAttr.Property.Name);
						}

						_lastFieldNameListType = value.GetType();
					}
		...
		/// <summary></summary>
		public virtual IList<string> FieldNameList 
		{ 
			get
			{
