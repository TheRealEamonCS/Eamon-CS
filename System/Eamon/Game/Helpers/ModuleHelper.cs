...
namespace Eamon.Game.Helpers
{
	...
	public class ModuleHelper : Helper<IModule>, IModuleHelper
	{
		...
		public virtual void InputNumRooms()
		{
			if (!EditRec)
			{
				Record.NumRooms = Globals.Database.GetRoomCount();
			}
		...
		public virtual void InputNumArtifacts()
		{
			if (!EditRec)
			{
				Record.NumArtifacts = Globals.Database.GetArtifactCount();
			}
		...
		public virtual void InputNumEffects()
		{
			if (!EditRec)
			{
				Record.NumEffects = Globals.Database.GetEffectCount();
			}
		...
		public virtual void InputNumMonsters()
		{
			if (!EditRec)
			{
				Record.NumMonsters = Globals.Database.GetMonsterCount();
			}
		...
		public virtual void InputNumHints()
		{
			if (!EditRec)
			{
				Record.NumHints = Globals.Database.GetHintCount();
			}
