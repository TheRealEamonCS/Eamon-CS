...
namespace Eamon.Framework.Plugin
{
	...
	public interface IPluginClassMappings
	{
		...
		/// EamonRT.Framework.Combat.ICombatSystem mapping to WrenholdsSecretVigil.Game.Combat.CombatSystem.  And why a call made to
		/// <see cref="CreateInstance{T}(Action{T})">CreateInstance</see> returns the game-specific CombatSystem object.
		/// </para>
		/// </remarks>
		/// <returns></returns>
		...
		/// CombatSystem pairs with ICombatSystem.  In this scenario, the class must always implement or inherit the interface;
