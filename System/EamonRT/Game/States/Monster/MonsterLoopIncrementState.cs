...
namespace EamonRT.Game.States
{
	...
	public class MonsterLoopIncrementState : State, IMonsterLoopIncrementState
	{
		...
		public override void Execute()
		{
			...
			while (true)
			{
				gEngine.LoopMonsterUid = gEngine.LoopMonsterUidListIndex < gEngine.LoopMonsterUidList.Count ? gEngine.LoopMonsterUidList[(int)(gEngine.LoopMonsterUidListIndex++)] : gDatabase.MonsterTable.CurrUid + 1;
